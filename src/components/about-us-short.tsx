                ...
                <div className="w-full flex-col justify-center lg:items-start items-center gap-10 inline-flex">
                    <div className="w-full flex-col justify-center items-start gap-8 flex">
                        <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                            ...
                            At WebElectra, we bring the latest and most reliable devices right to your fingertips. Our mission is to make technology accessible, affordable, and tailored to your needs. From smartphones to smart gadgets, we are your trusted partner in discovering the best innovations for your lifestyle.</p>
                        </div>
